 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `P_RouteYYModel` protocol for custom methods.
 ...
 */
@interface NSObject (P_RouteYYModel)
 ...
 */
@interface NSArray (P_RouteYYModel)
 ...
 */
@interface NSDictionary (P_RouteYYModel)
...
/**
 ...
 There's no need to add '<P_RouteYYModel>' to your class header.
 */
@protocol P_RouteYYModel <NSObject>
@optional
